...
const meta = {
  ...
  argTypes: {
    ...
    zoneText: { control: 'text', description: 'Copy. Defaults to the locale catalogue — “Zieh ein Foto hierher oder wähle eines von deinem Gerät.” in German.' },
    chooseLabel: { control: 'text', description: 'Copy. Defaults to the locale catalogue — “Foto wählen” / “Choose photo”.' },
    replaceLabel: { control: 'text', description: 'Copy. Defaults to the locale catalogue — “Ersetzen” / “Replace”.' },
    removeLabel: { control: 'text', description: 'Copy. Defaults to the locale catalogue — “Foto entfernen” / “Remove photo”. The remove control’s accessible name.' },
    errorWord: { control: 'text', description: 'Copy. Defaults to the catalogue’s status word — “Fehler” / “Error”. Screen-reader-only prefix on the error line.' },
